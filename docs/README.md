...
Índice dos guias desta pasta. Visão geral do produto e setup local: **[README.md na raiz](../README.md)**.

| Arquivo | Conteúdo |
|---------|----------|
| [FLUXO_ASAAS_WEBHOOK.md](./FLUXO_ASAAS_WEBHOOK.md) | Webhook Asaas → Edge `asaas-webhook` → Postgres |
| [MIGRACAO_NOVO_SUPABASE.md](./MIGRACAO_NOVO_SUPABASE.md) | Apontar o app para outro projeto Supabase |
| [SUPABASE_PROJETO_ATUAL.md](./SUPABASE_PROJETO_ATUAL.md) | Checklist do project ref já usado em `npm run supabase:link` |
