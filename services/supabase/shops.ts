...
export const SHOPS_SELECT_PARTNER_SINGLE =
  'id, share_code, owner_id, name, type, description, address, profile_image, banner_image, primary_color, theme, subscription_active, subscription_amount, billing_status, trial_days, trial_started_at, trial_ends_at, billing_blocked_at, rating, asaas_account_id, asaas_wallet_id, cnpj_cpf, email, phone, pix_key, split_percent, split_percent_sandbox, pass_fees_to_customer, workday_start, workday_end, lunch_start, lunch_end, agenda_slot_minutes, store_categories, asaas_api_key_configured, mp_preapproval_plan_id, updated_at, shop_finance_provision(finance_provision_status, finance_provision_last_error)';
export const SHOPS_SELECT_PARTNER_SINGLE_NO_SHARE_CODE =
  'id, owner_id, name, type, description, address, profile_image, banner_image, primary_color, theme, subscription_active, subscription_amount, billing_status, trial_days, trial_started_at, trial_ends_at, billing_blocked_at, rating, asaas_account_id, asaas_wallet_id, cnpj_cpf, email, phone, pix_key, split_percent, split_percent_sandbox, pass_fees_to_customer, workday_start, workday_end, lunch_start, lunch_end, agenda_slot_minutes, store_categories, asaas_api_key_configured, mp_preapproval_plan_id, updated_at, shop_finance_provision(finance_provision_status, finance_provision_last_error)';
...
export const SHOPS_SELECT_ADMIN_CORE =
  'id, share_code, owner_id, name, type, description, address, profile_image, banner_image, primary_color, theme, subscription_active, subscription_amount, billing_status, trial_days, trial_started_at, trial_ends_at, billing_blocked_at, rating, asaas_account_id, asaas_wallet_id, asaas_customer_id, asaas_platform_subscription_id, mp_preapproval_plan_id, cnpj_cpf, email, phone, pix_key, created_at, split_percent, split_percent_sandbox, pass_fees_to_customer, workday_start, workday_end, lunch_start, lunch_end, agenda_slot_minutes, store_categories, asaas_api_key_configured, shop_finance_provision(finance_provision_status, finance_provision_last_error)';
...
export const SHOPS_SELECT_ADMIN_LIST_LIGHT =
  'id, share_code, owner_id, name, type, profile_image, phone, subscription_active, subscription_amount, billing_status, trial_days, trial_started_at, trial_ends_at, billing_blocked_at, asaas_account_id, asaas_wallet_id, asaas_platform_subscription_id, mp_preapproval_plan_id, email, split_percent, split_percent_sandbox, pass_fees_to_customer, asaas_api_key_configured, shop_finance_provision(finance_provision_status, finance_provision_last_error), asaas_runtime_mode';
export const SHOPS_SELECT_ADMIN_LIST_LIGHT_NO_SHARE_CODE =
  'id, owner_id, name, type, profile_image, phone, subscription_active, subscription_amount, billing_status, trial_days, trial_started_at, trial_ends_at, billing_blocked_at, asaas_account_id, asaas_wallet_id, asaas_platform_subscription_id, mp_preapproval_plan_id, email, split_percent, split_percent_sandbox, pass_fees_to_customer, asaas_api_key_configured, shop_finance_provision(finance_provision_status, finance_provision_last_error), asaas_runtime_mode';
