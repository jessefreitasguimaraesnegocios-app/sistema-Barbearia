                ...
                {step === 4 && (
                  <div className="animate-fade-in space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {isProfileComplete ? (
                        <div className="bg-[#f5fff9] p-6 rounded-3xl border border-emerald-400 shadow-sm">
                          <h4 className="text-xs font-bold text-emerald-950 uppercase tracking-widest mb-2">Pagamento com os dados do seu perfil</h4>
                          <p className="text-sm font-medium text-gray-900">Usaremos <strong>{user.name}</strong> e seu CPF/telefone cadastrados. Nada a preencher.</p>
                          <p className="text-[11px] text-gray-800 mt-2">Para alterar, vá em <strong>Meu Perfil</strong> no menu.</p>
                        </div>
                      ) : (
                      <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
